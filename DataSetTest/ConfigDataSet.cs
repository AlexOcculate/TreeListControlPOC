...
namespace DataSetTest
{
    public class ConfigDataSet
    {
        ...
        public ConfigDataSet()
        {
            ...
            {
                ds.DataSetName = ConfigDataSet.DATASET_NM;
                ds.Namespace = ConfigDataSet.DATASET_NAMESPACE;
                ds.Prefix = ConfigDataSet.DATASET_PREFIX;
                {
        ...
        private DataTable createConfigTableStructure()
        {
            DataTable o = new DataTable();
            {
                o.Columns.Add(ConfigDataSet.ID_FIELD_NM, typeof(int));
                o.Columns.Add(ConfigDataSet.PARENTID_FIELD_NM, typeof(int));
                o.Columns.Add(ConfigDataSet.ISFOLDER_FIELD_NM, typeof(bool));
                o.Columns.Add(ConfigDataSet.NAME_FIELD_NM, typeof(string));
                o.Columns.Add(ConfigDataSet.PREVIEW_FIELD_NM, typeof(string));
                o.Columns.Add(ConfigDataSet.TYPE_FIELD_NM, typeof(string));
                o.Columns.Add(ConfigDataSet.URI_FIELD_NM, typeof(string));
        ...
        {
            DataTable o = this.createConfigTableStructure();
            o.TableName = ConfigDataSet.CONFIG_TBL_NM;
            {
